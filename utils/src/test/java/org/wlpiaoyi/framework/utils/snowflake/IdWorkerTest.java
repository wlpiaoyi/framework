...
public class IdWorkerTest {
    ...
    public void test() throws Exception {
        ...
        timerEpoch = DateUtils.parseTimestamp(DateUtils.parseLocalDateTime("2010-01-01 08:00:00"));
        idWorker = new IdWorker((byte) 1, (byte) 2, timerEpoch);
        id = idWorker.nextId();
        System.out.println(Long.toBinaryString(id));
        System.out.println(id);
        timerEpoch = DateUtils.parseTimestamp(DateUtils.parseLocalDateTime("2000-01-01 08:00:00"));
        idWorker = new IdWorker((byte) 1, (byte) 2, timerEpoch);
        id = idWorker.nextId();
        System.out.println(Long.toBinaryString(id));
        System.out.println(id);
        timerEpoch = DateUtils.parseTimestamp(DateUtils.parseLocalDateTime("1970-01-01 08:00:00"));
        idWorker = new IdWorker((byte) 1, (byte) 2, timerEpoch);
        id = idWorker.nextId();
        System.out.println(Long.toBinaryString(id));
        System.out.println(id);
        timerEpoch = DateUtils.parseTimestamp(DateUtils.parseLocalDateTime("1960-01-01 08:00:00"));
        idWorker = new IdWorker((byte) 1, (byte) 2, timerEpoch);
        id = idWorker.nextId();
        System.out.println(Long.toBinaryString(id));
        System.out.println(id);
