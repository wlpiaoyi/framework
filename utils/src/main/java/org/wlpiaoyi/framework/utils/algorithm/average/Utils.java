...
class Utils {
    ...
    static double toDouble(double value1, double value2){
        ...
        double r1 = toDouble(v1_1, v2_1);
        if(v1_2 > 0 || v2_2 > 0){
            double r2 = toDouble(v1_2, v2_2);
    ...
    static double toDouble(long value1, long value2){
        return (value1 & value2) + (value1 ^ value2) / 2.0;
    }
    static long toLong(long value1, long value2){
        return (value1 & value2) + (value1 ^ value2) / 2;
    }

    public static void main(String[] args) {
        toDouble(1.001, 3.002);
    }
}
